...
import { Button, Dropdown, Input, Drawer, Space } from "antd";
...
function Header() {
    ...
    const itemsLoginSuccess = [
        ...
        },
        {
            key: "2", // Định danh duy nhất cho mục này
            label: (
                <Link to={ROUTES.USER_CHANGE_PASSWORD_PAGE}>
                    Change password
                </Link>
                    ...
                    <li>
                        <div>
                            <Link to={ROUTES.PRODUCT_PAGE}>
                                ...
                                <DownOutlined
                                    onClick={handleToggleSubNavProductMobile}
                                />
                            </Link>
                        </div>
                        <ul
                        ...
                        >
                            {/* Mục "Adidas" trong thanh điều hướng con sản phẩm */}
                            <li
                                className="header-navBar__subNavProduct--rings"
                                onClick={handleFilterAdidasProduct}
                            >
                                Adidas
                            </li>

                            {/* Mục "Nike" trong thanh điều hướng con sản phẩm */}
                            <li
                                className="header-navBar__subNavProduct--earrings"
                                onClick={handleFilterNikeProduct}
                            >
                                Nike
                            </li>

                            {/* Mục "MLB" trong thanh điều hướng con sản phẩm */}
                            <li
                                className="header-navBar__subNavProduct--necklaces"
                                onClick={handleFilterMlbProduct}
                            >
                                MLB
                            </li>
                        </ul>
