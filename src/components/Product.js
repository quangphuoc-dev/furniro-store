...
function Product() {
    return (
        <div className="product-session py-[55px] px-[100px] mb-[70px]">
            ...
            <div className="product-items grid grid-cols-4 inline-grid gap-[32px]">
                <div>
                    ...
                    <div className='bg-[#f4f5f7]   h-[145px]'>
                        <span className='text-[24px] leading-[1.2] text-[#3a3a3a] font-[600] block pt-[16px]'>Syltherine</span>
                        <p className='text-[16px] leading-[1.5] text-[#898989] font-[500] py-[8px]'>Stylish cafe chair</p>
                        <div>
                            <span className='text-[20px] leading-[1.5] text-[3a3a3a] font-[600] pr-[16px]'>Rp 2.500.000</span>
                ...
                <div>
                    ...
                    <div className='bg-[#f4f5f7]   h-[145px]'>
                        <span className='text-[24px] leading-[1.2] text-[#3a3a3a] font-[600] block pt-[16px]'>Leviosa</span>
                        <p className='text-[16px] leading-[1.5] text-[#898989] font-[500] py-[8px]'>Stylish cafe chair</p>
                ...
                <div>
                    ...
                    <div className='bg-[#f4f5f7]   h-[145px]'>
                        <span className='text-[24px] leading-[1.2] text-[#3a3a3a] font-[600] block pt-[16px]'>Lolito</span>
                        <p className='text-[16px] leading-[1.5] text-[#898989] font-[500] py-[8px]'>Luxury big sofa</p>
                        <div>
                            <span className='text-[20px] leading-[1.5] text-[3a3a3a] font-[600] pr-[16px]'>Rp 7.000.000</span>
                ...
                <div>
                    ...
                    <div className='bg-[#f4f5f7]   h-[145px]'>
                        <span className='text-[24px] leading-[1.2] text-[#3a3a3a] font-[600] block pt-[16px]'>Respira</span>
                        <p className='text-[16px] leading-[1.5] text-[#898989] font-[500] py-[8px]'>Outdoor bar table and stool</p>
                        <div className='mx-[16px]'>
                ...
                <div>
                    ...
                    <div className='bg-[#f4f5f7]   h-[145px]'>
                        <span className='text-[24px] leading-[1.2] text-[#3a3a3a] font-[600] block pt-[16px]'>Grifo</span>
                        <p className='text-[16px] leading-[1.5] text-[#898989] font-[500] py-[8px]'>Night lamp</p>
                        <div className='mx-[16px]'>
                ...
                <div>
                    ...
                    <div className='bg-[#f4f5f7]   h-[145px]'>
                        <span className='text-[24px] leading-[1.2] text-[#3a3a3a] font-[600] block pt-[16px]'>Muggo</span>
                        <p className='text-[16px] leading-[1.5] text-[#898989] font-[500] py-[8px]'>Small mug</p>
                        <div className='mx-[16px]'>
                ...
                <div>
                    ...
                    <div className='bg-[#f4f5f7]   h-[145px]'>
                        <span className='text-[24px] leading-[1.2] text-[#3a3a3a] font-[600] block pt-[16px]'>Pingky</span>
                        <p className='text-[16px] leading-[1.5] text-[#898989] font-[500] py-[8px]'>Cute bed set</p>
                        <div>
                            <span className='text-[20px] leading-[1.5] text-[3a3a3a] font-[600] pr-[16px]'>Rp 7.000.000</span>
                            <span className='text-[16px] leading-[1.5] text-[#b0b0b0] font-[400] line-through'>Rp 14.000.000</span>
                        </div>
                ...
                <div>
                    ...
                    <div className='bg-[#f4f5f7]   h-[145px]'>
                        <span className='text-[24px] leading-[1.2] text-[#3a3a3a] font-[600] block pt-[16px]'>Potty</span>
                        <p className='text-[16px] leading-[1.5] text-[#898989] font-[500] py-[8px]'>Minimalist flower pot</p>
                        <div className='mx-[16px]'>
                            <span className='text-[20px] leading-[1.5] text-[3a3a3a] font-[600] pr-[16px] block text-left'>Rp 500.000</span>
                        </div>
                    </div>
