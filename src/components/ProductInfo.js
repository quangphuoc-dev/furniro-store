    ...
    return (
        <div className="border-t-2 border-b-2">
            <div className="product-info-title flex justify-center gap-[52px] mb-[36px] mt-[48px]">
                <span className='text-[24px] text-[#9f9f9f] font-[400]'>Description</span>
                <span className='text-[24px] text-[#9f9f9f] font-[400]'>Additional Information</span>
                <span className='text-[24px] text-[#9f9f9f] font-[400]'>Reviews [5]</span>
            </div>
            ...
            <div className="product-info-img flex  justify-center items-center gap-[29px] mt-[36px] mb-[66px]">
                <img src={ProInfo1} className='bg-[#f9f1e7] rounded-[10px] w-[605px] h-[348px]'/>
                <img src={ProInfo2} className='bg-[#f9f1e7] rounded-[10px] w-[605px] h-[348px] '/>
            </div>
        </div>
    )
}
