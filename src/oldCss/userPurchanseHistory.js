    ...
    <div className="bg-slate-200">
        <div className="flex justify-between">
            <div className="flex gap-3">
                <span className="text-[#ffffff] bg-[#b88e2f] font-[600]">
                    Yêu thích
                </span>
        ...
        <div className="flex justify-between gap-4">
            <div className="flex justify-center gap-3">
                ...
                <div className="flex flex-col">
                    ...
                    <span className="border-[1px] border-solid border-[#000000]">
        ...
        <div className="">
            <div className="flex justify-end gap-3">
                ...
                <span className="text-[#b88e2f] font-[6000] text-[20px]">
                    Số tiền
                </span>
            </div>
            <div className="flex justify-end gap-3">
                <button className="border-[1px] border-solid border-[#ffffff] bg-[#b88e2f] text-[#ffffff]">
                    Mua Lại
                </button>
                <button className="border-[1px] border-solid border-[#000000]">
                    Liên Hệ
                </button>
            </div>
        </div>
